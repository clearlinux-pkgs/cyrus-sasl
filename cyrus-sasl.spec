...
#
# Source0 file verified with key 0xE3D7C118C7B9F46A (mail@spartha.org)
#
Name     : cyrus-sasl
Version  : 2.1.27.rc8
Release  : 3
URL      : ftp://ftp.cyrusimap.org/cyrus-sasl/cyrus-sasl-2.1.27-rc8.tar.gz
Source0  : ftp://ftp.cyrusimap.org/cyrus-sasl/cyrus-sasl-2.1.27-rc8.tar.gz
Source99 : ftp://ftp.cyrusimap.org/cyrus-sasl/cyrus-sasl-2.1.27-rc8.tar.gz.sig
Summary  : SASL API implementation
Group    : Development/Tools
License  : APSL-1.1 BSD-3-Clause-Attribution
...
export LANG=C
export SOURCE_DATE_EPOCH=1535235102
%configure --disable-static --with-rc4=no
make
...
cp dlcompat-20010505/APPLE_LICENSE %{buildroot}/usr/share/doc/cyrus-sasl/dlcompat-20010505_APPLE_LICENSE
...
/usr/share/doc/cyrus-sasl/dlcompat-20010505_APPLE_LICENSE
